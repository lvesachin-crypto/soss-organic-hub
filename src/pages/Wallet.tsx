...
export default function Wallet() {
  ...
  return (
    <DashboardLayout>
      <PageMeta title="Wallet & Top-up" description="Add funds via UPI or crypto and review your Extips Panel wallet balance and transaction history." canonicalPath="/wallet" noIndex />
