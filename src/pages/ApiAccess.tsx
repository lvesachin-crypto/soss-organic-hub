...
export default function ApiAccess() {
    ...
    return (
        <DashboardLayout>
            <PageMeta title="API Access & Reseller Docs" description="Generate your Boostly Pro API key and integrate our SMM services into your own panel or workflow." canonicalPath="/api-access" noIndex />
                    ...
                    {apiKey ? (
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-2 text-xs text-zinc-500 px-1">
                                ...
                                <span>Keep this key secret. Do not share it with anyone.</span>
                            </div>
                        ...
                        <div className="text-center py-10 space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 mt-1">Generate one using the button below</p>
                            </div>
                            <Button
                                onClick={handleGenerateKey}
                                disabled={isGenerating}
                ...
                <div className="rounded-2xl bg-zinc-950 border border-white/[0.07] p-6 space-y-6">
                    ...
                    <div className="flex items-start gap-3 p-4 rounded-xl bg-amber-500/5 border border-amber-500/20">
                        ...
                        <p className="text-xs text-amber-200/70">
                            Send all requests using the <code className="bg-amber-500/10 px-1 py-0.5 rounded text-amber-300">POST</code> method and include the <code className="bg-amber-500/10 px-1 py-0.5 rounded text-amber-300">key</code> field in the body.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <EndpointCard
                            ...
                            action="services"
                            label="Services List"
                            description="View all available services and their rates"
                            request={`{\n  "key": "YOUR_API_KEY",\n  "action": "services"\n}`}
                        ...
                        <EndpointCard
                            ...
                            action="add"
                            label="Place Order"
                            description="Place a new order (amount will be deducted from your wallet)"
