...
export default function ApiAccess() {
    ...
    return (
        <DashboardLayout>
            <PageMeta title="API Access & Reseller Docs" description="Generate your OrganicSMM API key and integrate our SMM services into your own panel or workflow." canonicalPath="/api-access" noIndex />
