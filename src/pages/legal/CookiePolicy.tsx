...
export default function CookiePolicy() {
  return (
    <>
      <PageMeta title="Cookie Policy | ExtipsPanel" description="Learn about how ExtipsPanel uses cookies and similar technologies." canonicalPath="/cookies" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Cookie Policy", path: "/cookies" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>ExtipsPanel uses cookies and similar technologies for the following purposes:</p>
