...
export default function RefundPolicy() {
  return (
    <>
      <PageMeta title="Refund Policy | ExtipsPanel" description="Understand ExtipsPanel's refund and cancellation policies." canonicalPath="/refund" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Refund Policy", path: "/refund" }]} />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex gap-3 p-4 mb-8 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-400/90">
            ...
            <p className="text-sm leading-relaxed">
              <strong className="text-amber-400">Notice:</strong> ExtipsPanel provides <strong>intangible digital services</strong>. Once services are delivered, they cannot be reversed or returned. Please read this policy carefully before making a purchase.
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <section className="space-y-3">
              ...
              <p>Funds added to your ExtipsPanel wallet are considered <strong className="text-foreground">service credits</strong> and are generally non-refundable. Refunds for wallet deposits may be considered only under:</p>
              <ul className="list-disc pl-6 space-y-1">
