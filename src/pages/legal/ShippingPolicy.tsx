...
export default function ShippingPolicy() {
  return (
    <>
      <PageMeta
        title="Shipping & Delivery Policy | ExtipsPanel"
        description="ExtipsPanel delivers digital services electronically. Learn about our delivery timelines and process."
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex gap-3 p-4 mb-8 rounded-xl bg-orange-500/10 border border-orange-500/20">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              ExtipsPanel provides <strong>100% digital services</strong>. No physical products are shipped. All deliveries are electronic and happen directly on the target social media account/link provided at the time of order.
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            <section className="space-y-3">
              ...
              <p>All services offered by ExtipsPanel (followers, likes, views, comments, etc.) are digital, intangible services that are fulfilled by our automated system and partner providers directly on the user's social media account or link. There is no physical shipment, courier or postal delivery involved.</p>
            </section>
