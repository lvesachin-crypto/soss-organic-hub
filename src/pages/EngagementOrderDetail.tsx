...
export default function EngagementOrderDetail() {
  ...
  return (
    <DashboardLayout>
      <PageMeta title="Engagement Order Detail" description="Live progress, delivery timeline, and per-run breakdown for your ExtipsPanel engagement order." noIndex />
