  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-[#2563EB] group-[.toaster]:text-white group-[.toaster]:border group-[.toaster]:border-white/10 group-[.toaster]:shadow-[0_10px_40px_-8px_rgba(14,27,77,0.45)] group-[.toaster]:rounded-2xl group-[.toaster]:px-4 group-[.toaster]:py-3.5 group-[.toaster]:min-w-[280px] group-[.toaster]:max-w-[440px] group-[.toaster]:gap-3 group-[.toaster]:items-start",
          title:
          ...
          actionButton:
            "group-[.toast]:bg-[#2563EB] group-[.toast]:text-white group-[.toast]:rounded-full group-[.toast]:font-semibold group-[.toast]:text-xs group-[.toast]:px-4 group-[.toast]:py-1.5 group-[.toast]:transition-all hover:group-[.toast]:brightness-110",
          cancelButton:
          ...
          error: "group-[.toaster]:border-l-4 group-[.toaster]:border-l-[#2563EB]",
      ...
      icons={{
        ...
        error: (
          <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#2563EB]/25 ring-1 ring-[#2563EB]/50 flex items-center justify-center mt-0.5">
